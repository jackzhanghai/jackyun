...
- (void)_layoutExtremities
{
    ...
    if (_gridFooterView != nil) {
		...
		footerRect.origin.x = (self.frame.size.width - footerRect.size.width) / 2;
...
- (void)reloadItemsAtIndexPaths:(id<NSFastEnumeration>)indexPaths
{
...
- (KKGridViewCell *)cellForIndexPath:(KKIndexPath *)indexPath
{
