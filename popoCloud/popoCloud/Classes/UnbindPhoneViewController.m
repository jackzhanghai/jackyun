...
- (void)viewDidLoad
{
    ...
    self.labelPhone.text = [[PCUserInfo currentUser] phone];
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [MobClick beginLogPageView:@"UnbindPhoneView"];
}
- (void)viewWillDisappear:(BOOL)animated {
    [super viewWillDisappear:animated];
    [MobClick endLogPageView:@"UnbindPhoneView"];
}
...
- (IBAction)unbind:(id)sender {
    ...
    [accountManagement unbindPhoneWithPassword:self.textFieldPassword.text];
...
-(void)unbindPhoneSuccess:(PCAccountManagement *)pcAccountManagement
{
    ...
    [[PCUserInfo currentUser] setPhone:nil];
